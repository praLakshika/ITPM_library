...
<div class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
    ...
    <div class="form-group">
        {!! Form::open(array('route' => 'patient.appointments.checkDate')) !!}
    ...
    {!! Form::open(array('route' => 'patient.appointments.checkDate.store')) !!}
        ...
        <a href="{{ route('patient.appointments') }}" class="btn btn-light"><i class="fa fa-arrow-left"></i> Go Back</a>
